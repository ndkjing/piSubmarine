...
public class MQTTService extends MqttService {
    ...
    public  static  String device_code = "a";
//    private String host = "tcp://47.97.183.24:1884";
    private String host = "tcp://116.62.44.118:1883";
    private String userName = "admin";
    private String passWord = "public";
    private static String myTopic = "test";      //要订阅的主题
    public static String[] myTopicList = new String[]{"status_data_"+device_code,"high_f_status_data_"+device_code};      //要订阅的主题
    private String clientId = "androidId";//客户端标识
    private IGetMessageCallBack IGetMessageCallBack;
    public static boolean is_connect=false;   //判断是否已经连接上
    ...
    // topic 话题名称  msg消息
    public static void publish_topic(String topic,String msg){
        Integer qos = 0;
        Boolean retained = false;
        try {
            if (client != null){
...
//                IGetMessageCallBack.setMessage(str1);
                IGetMessageCallBack.setTopicMessage(topic,str1);
            }
